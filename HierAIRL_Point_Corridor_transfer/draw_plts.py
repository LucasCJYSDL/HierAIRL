...
def plot():
    ...
    file_dir = {'H-AIRL': [22795, 22833, 22858], 'H-AIRL-init': [22915, 22973], 'GAIL': [28624, 28724, 28801],
                'Option-GAIL': [28883, 29031, 29179]}
    ...
    for i in range(temp_len):
        data_frame = data_frame.append({'algorithm': 'Expert', 'Step': temp_step[i] * 4096, 'Reward': 171.56}, ignore_index=True)
