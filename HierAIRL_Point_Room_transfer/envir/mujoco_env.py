...
if __name__ == '__main__':
    ...
    # get_demo_stat(path="Point4Rooms-v1_sample.torch")
    # collect_demo(config=None, n_demo=10000, is_manual=True, env_name='PointCorridor-v1')
    # get_demo_stat(path="PointCorridor-v1_sample.torch")
    # collect_demo(config=None, n_demo=10000, is_manual=True, env_name='PointCorridor-v2')
    get_demo_stat(path="PointCorridor-v2_sample.torch")
